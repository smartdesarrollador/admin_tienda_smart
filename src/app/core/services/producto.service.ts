...
export class ProductoService {
  ...
  createProducto(data: CreateProductoRequest): Observable<ProductoResponse> {
    ...
    return this.http
      .post<ProductoResponse>(`${this.baseUrl}/admin/productos`, formData)
      .pipe(
        tap((response) => {
          this.updateState({
            currentProducto: response.data,
  ...
  /**
   * Actualizar producto existente usando POST method
   */
  updateProducto(
    id: number,
    ...
    const formData = this.buildFormData(data, true);

    return this.http
      .post<ProductoResponse>(
        `${this.baseUrl}/admin/productos/${id}/update`,
        formData
      )
      .pipe(
        tap((response) => {
  ...
  deleteProducto(id: number): Observable<void> {
    ...
    return this.http.delete<void>(`${this.baseUrl}/admin/productos/${id}`).pipe(
      tap(() => {
        this.updateState({
          currentProducto: null,
        });
  ...
  toggleDestacado(id: number): Observable<ProductoResponse> {
    ...
    return this.http
      .post<ProductoResponse>(
        `${this.baseUrl}/admin/productos/${id}/toggle-destacado`,
        {}
      )
      .pipe(
        tap((response) => {
  ...
  toggleActivo(id: number): Observable<ProductoResponse> {
    ...
    return this.http
      .post<ProductoResponse>(
        `${this.baseUrl}/admin/productos/${id}/toggle-activo`,
        {}
      )
      .pipe(
        tap((response) => {
  ...
  removeImagenPrincipal(id: number): Observable<ProductoResponse> {
    ...
    return this.http
      .delete<ProductoResponse>(
        `${this.baseUrl}/admin/productos/${id}/imagen-principal`
      )
      .pipe(
        tap((response) => {
          this.updateState({
  ...
  getStatistics(): Observable<ProductoStatistics> {
    ...
    const url = `${this.baseUrl}/admin/productos/statistics`;
  ...
  private buildFormData(
    ...
    // Ya no necesitamos _method para Laravel con POST directo
    // El parámetro isUpdate se mantiene para compatibilidad futura
